...
/* package distributed-process-async-0.2.4.1 */
#define VERSION_distributed_process_async "0.2.4.1"
#define MIN_VERSION_distributed_process_async(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 4)

/* package distributed-process-client-server-0.2.3 */
#define VERSION_distributed_process_client_server "0.2.3"
#define MIN_VERSION_distributed_process_client_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 3)

/* package distributed-process-extras-0.3.2 */
#define VERSION_distributed_process_extras "0.3.2"
...
#define CURRENT_COMPONENT_ID "chatServer-0.1.0.0-F55iXHiCgeG4OgnGdEtvot"

#define CURRENT_PACKAGE_KEY "chatServer-0.1.0.0-F55iXHiCgeG4OgnGdEtvot"
